function [ dissipation_m ] = F_compute_dissipation_m( string_modes_n, ...
    string_tension, string_linear_mass, ...
    effective_stiffnesses_v, effective_masses_v, ...
    string_q_factors_v, body_q_factors_v )
%% Dissipation matrix, C, computation
% 

%% String block
dissipation_1_1_v = pi*sqrt(string_tension*string_linear_mass)/2 * ...
    (1:string_modes_n) ./ string_q_factors_v.';
