function [ string_linear_mass, string_bending_stiffness, ...
    string_tension, string_celerity, ...
...
celerities_v = [ 107, 143, 191, 255, 321, 429 ];

eta_F_v = (1e-6)*[2,7,5,14,40,40];
eta_B_v = (1e-5)*[2,2.5,2,2,2,2.4];
eta_A_v = (1e-2)*[1.2, 0.9, 1.2, 1.7, 1.2, 1.5];
...
string_celerity = celerities_v(note_n);
