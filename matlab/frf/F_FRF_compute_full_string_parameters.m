function [ string_params ] = F_FRF_compute_full_string_parameters( ...
    str_note_name, string_modes_number, excitation_bridge_dist )
...
initial_height  = 0.01;
delta_excitation = excitation_bridge_dist;  % Distance to the bridge
