...
A défaut d'utiliser ce protocole pour extraire les paramètres de la synthèse par FRF, les valeurs fournies par Woodhouse \cite{woodhouse2004plucked} seront utilisées.
